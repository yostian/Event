  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="" class="scrollto"><img src="" alt="" title="">The Event</a>
      </div>

      <nav id="nav-menu-container">
        <ul class="nav-menu">
            <!-- This Home Include Database -->
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="speaker">
              ...
              <div class="details">
                <h3><a href="welcome/speakersdetail">Brenden Legros</a></h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker">
              ...
              <div class="details">
                <h3><a href="welcome/speakersdetail">Hubert Hirthe</a></h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker">
              ...
              <div class="details">
                <h3><a href="welcome/speakersdetail">Cole Emmerich</a></h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker">
              ...
              <div class="details">
                <h3><a href="welcome/speakersdetail">Jack Christiansen</a></h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker">
              ...
              <div class="details">
                <h3><a href="welcome/speakersdetail">Alejandrin Littel</a></h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker">
              ...
              <div class="details">
                <h3><a href="welcome/speakersdetail">Willow Trantow</a></h3>
                <p>Non autem dicta</p>
                <div class="social">
                  <a href=""><i class="fa fa-twitter"></i></a>
                  <a href=""><i class="fa fa-facebook"></i></a>
    ...
    <section id="buy-tickets" class="section-with-bg wow fadeInUp">
      <div class="container">
        ...
        <div class="section-header">
          ...
          <div class="text-center">
              <a href="#"><button class="btn">Join Us</button></a>
          </div>
